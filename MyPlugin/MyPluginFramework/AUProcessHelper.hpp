//
//  AudioPluginAUProcessHelper.hpp
//  AudioPlugin
//
...
#include <vector>
#include "MyPluginDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(AudioPluginDSPKernel& kernel, UInt32 inputChannelCount, UInt32 outputChannelCount)
    : mKernel{kernel},
